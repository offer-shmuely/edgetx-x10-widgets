...
local function translate(nam)
    local translations = {
        ...
        non_invert_arm_switch="non invert arm switch",
    }
...
local function update(wgt, options)
    ...
    wgt.options = options
    wgt.use_telemetry = use_telemetry
    wgt.enable_sounds = enable_sounds
    ...
    -- log("auto_debug: %s, wgt.zone.h: %s", wgt.options.is_debug, wgt.zone.h)
