...
local function fillDataForSingleVoltage(wgt, singleVoltage)
  if     singleVoltage < 4.3  then  return {singleVoltage}
  elseif singleVoltage < 8.6  then  return {singleVoltage/2, singleVoltage/2}
  elseif singleVoltage < 12.9 then  return {singleVoltage/3, singleVoltage/3, singleVoltage/3}
  elseif singleVoltage < 17.2 then  return {singleVoltage/4, singleVoltage/4, singleVoltage/4, singleVoltage/4}
  elseif singleVoltage < 21.5 then  return {singleVoltage/5, singleVoltage/5, singleVoltage/5, singleVoltage/5, singleVoltage/5}
  elseif singleVoltage < 25.8 then  return {singleVoltage/6, singleVoltage/6, singleVoltage/6, singleVoltage/6, singleVoltage/6, singleVoltage/6}
  end
...
local function calculateBatteryData(wgt)
  ...
  elseif newCellData ~= nil and newCellData >= 1 then
    ...
    --print("only one cell using VFAS lipo sensor")
    newCellData = fillDataForSingleVoltage(wgt, newCellData)
